...
export function UserContextProvider({ children }) { // Changed function name to follow convention
  ...
  return (
    <UserContext.Provider value={{ user, setUser, logout }}> {/* Changed variable name to follow convention */}
      {children}
